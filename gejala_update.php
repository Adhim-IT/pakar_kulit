    ...
    <form class="form-horizontal" action="<?php echo $link_update; ?>" method="post">
        ...
        <div class="box-body">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <input name="kode_gejala" id="kode_gejala" class="form-control" required type="text"
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <input name="nama_gejala" id="nama_gejala" class="form-control" required type="text"
                        value="<?php echo $nama_gejala; ?>">
                </div>
            </div>
        </div>
