    ...
    <form class="form-horizontal" action="<?php echo $link_update; ?>" method="post">
        ...
        <div class="box-body">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <input name="kode_penyakit" id="kode_penyakit" class="form-control" required type="text"
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <input name="nama_penyakit" id="nama_penyakit" class="form-control" required type="text"
                        value="<?php echo $nama_penyakit; ?>">
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <textarea name="deskripsi" id="deskripsi" class="form-control"
                        rows="6"><?php echo $deskripsi; ?></textarea>
                </div>
            </div>
            <div class="form-group">
