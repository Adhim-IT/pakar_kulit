    ...
    <form class="form-horizontal" action="<?php echo $link_update; ?>" method="post">
        ...
        <div class="box-body">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <input name="kode_penyakit" id="kode_penyakit" class="form-control" readonly type="text"
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <input name="nama_penyakit" id="nama_penyakit" class="form-control" readonly type="text"
